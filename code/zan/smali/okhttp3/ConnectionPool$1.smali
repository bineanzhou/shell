...
.method public run()V
    ...
    invoke-virtual {v0, v2, v3}, Lokhttp3/ConnectionPool;->a(J)J
    ...
    .line 64
    iget-object v4, p0, Lokhttp3/ConnectionPool$1;->a:Lokhttp3/ConnectionPool;

    monitor-enter v4

    .line 66
    :try_start_0
    iget-object v5, p0, Lokhttp3/ConnectionPool$1;->a:Lokhttp3/ConnectionPool;
