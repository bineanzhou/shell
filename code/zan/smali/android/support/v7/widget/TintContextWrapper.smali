...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/TintContextWrapper;->a:Ljava/lang/Object;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/TintContextWrapper;->c:Landroid/content/res/Resources;

    .line 97
    iget-object v0, p0, Landroid/support/v7/widget/TintContextWrapper;->c:Landroid/content/res/Resources;

    invoke-virtual {v0}, Landroid/content/res/Resources;->newTheme()Landroid/content/res/Resources$Theme;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/TintContextWrapper;->d:Landroid/content/res/Resources$Theme;

    .line 98
    iget-object v0, p0, Landroid/support/v7/widget/TintContextWrapper;->d:Landroid/content/res/Resources$Theme;
...
.method public static a(Landroid/content/Context;)Landroid/content/Context;
    ...
    .prologue
    .line 45
    invoke-static {p0}, Landroid/support/v7/widget/TintContextWrapper;->b(Landroid/content/Context;)Z
    ...
    .line 46
    sget-object v2, Landroid/support/v7/widget/TintContextWrapper;->a:Ljava/lang/Object;

    monitor-enter v2

    .line 47
    :try_start_0
    sget-object v0, Landroid/support/v7/widget/TintContextWrapper;->b:Ljava/util/ArrayList;
    ...
    sput-object v0, Landroid/support/v7/widget/TintContextWrapper;->b:Ljava/util/ArrayList;
    ...
    .line 69
    sget-object v1, Landroid/support/v7/widget/TintContextWrapper;->b:Ljava/util/ArrayList;
