...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/SnapHelper;->d:Landroid/support/v7/widget/RecyclerView$OnScrollListener;
...
.method private b()V
    ...
    .prologue
    .line 113
    iget-object v0, p0, Landroid/support/v7/widget/SnapHelper;->b:Landroid/support/v7/widget/RecyclerView;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/SnapHelper;->d:Landroid/support/v7/widget/RecyclerView$OnScrollListener;
...
.method private b(Landroid/support/v7/widget/RecyclerView$LayoutManager;II)Z
    .locals 4
    ...
    .line 162
    :cond_1
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/SnapHelper;->b(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/support/v7/widget/LinearSmoothScroller;
    ...
    .line 167
    invoke-virtual {p0, p1, p2, p3}, Landroid/support/v7/widget/SnapHelper;->a(Landroid/support/v7/widget/RecyclerView$LayoutManager;II)I
    ...
    .line 172
    invoke-virtual {v1, v2}, Landroid/support/v7/widget/RecyclerView$SmoothScroller;->d(I)V

    .line 173
    invoke-virtual {p1, v1}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->a(Landroid/support/v7/widget/RecyclerView$SmoothScroller;)V
...
.method a()V
    ...
    .line 190
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/SnapHelper;->a(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/view/View;
    ...
    .line 194
    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/SnapHelper;->a(Landroid/support/v7/widget/RecyclerView$LayoutManager;Landroid/view/View;)[I
    ...
    .line 196
    :cond_2
    iget-object v1, p0, Landroid/support/v7/widget/SnapHelper;->b:Landroid/support/v7/widget/RecyclerView;
...
.method public a(Landroid/support/v7/widget/RecyclerView;)V
    ...
    .line 100
    :cond_2
    iput-object p1, p0, Landroid/support/v7/widget/SnapHelper;->b:Landroid/support/v7/widget/RecyclerView;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/SnapHelper;->c:Landroid/widget/Scroller;
...
.method public a(II)Z
    ...
    .line 70
    :cond_1
    iget-object v2, p0, Landroid/support/v7/widget/SnapHelper;->b:Landroid/support/v7/widget/RecyclerView;
    ...
    .line 76
    :cond_2
    invoke-direct {p0, v1, p1, p2}, Landroid/support/v7/widget/SnapHelper;->b(Landroid/support/v7/widget/RecyclerView$LayoutManager;II)Z
...
.method public b(II)[I
    ...
    .line 139
    iget-object v0, p0, Landroid/support/v7/widget/SnapHelper;->c:Landroid/widget/Scroller;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/SnapHelper;->c:Landroid/widget/Scroller;
