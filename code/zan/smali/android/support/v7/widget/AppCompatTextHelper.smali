...
.method a(Landroid/content/Context;I)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/TintTypedArray;->j(I)Z
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/TintTypedArray;->a(IZ)Z
    ...
    .line 157
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/TintTypedArray;->g(I)Landroid/content/res/ColorStateList;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v6, p1, v3, p2, v2}, Landroid/support/v7/widget/TintTypedArray;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/TintTypedArray;
    ...
    invoke-virtual {v3, v4, v8}, Landroid/support/v7/widget/TintTypedArray;->g(II)I
    ...
    invoke-virtual {v3, v7}, Landroid/support/v7/widget/TintTypedArray;->j(I)Z
    ...
    .line 64
    invoke-virtual {v3, v7, v2}, Landroid/support/v7/widget/TintTypedArray;->g(II)I
    ...
    .line 78
    :cond_3
    invoke-virtual {v3}, Landroid/support/v7/widget/TintTypedArray;->e()V
    ...
    invoke-static {v6, v4, v0}, Landroid/support/v7/widget/TintTypedArray;->a(Landroid/content/Context;I[I)Landroid/support/v7/widget/TintTypedArray;
    ...
    invoke-virtual {v8, v0}, Landroid/support/v7/widget/TintTypedArray;->j(I)Z
    ...
    invoke-virtual {v8, v0, v2}, Landroid/support/v7/widget/TintTypedArray;->a(IZ)Z
    ...
    invoke-virtual {v8, v4}, Landroid/support/v7/widget/TintTypedArray;->j(I)Z
    ...
    invoke-virtual {v8, v4}, Landroid/support/v7/widget/TintTypedArray;->g(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v8, v9}, Landroid/support/v7/widget/TintTypedArray;->j(I)Z
    ...
    invoke-virtual {v8, v5}, Landroid/support/v7/widget/TintTypedArray;->g(I)Landroid/content/res/ColorStateList;
    ...
    :cond_4
    :goto_2
    invoke-virtual {v8}, Landroid/support/v7/widget/TintTypedArray;->e()V

    .line 112
    :goto_3
    sget-object v8, Landroid/support/v7/appcompat/R$styleable;->TextAppearance:[I

    invoke-static {v6, p1, v8, p2, v2}, Landroid/support/v7/widget/TintTypedArray;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/TintTypedArray;
    ...
    invoke-virtual {v6, v8}, Landroid/support/v7/widget/TintTypedArray;->j(I)Z
    ...
    invoke-virtual {v6, v1}, Landroid/support/v7/widget/TintTypedArray;->j(I)Z
    ...
    invoke-virtual {v6, v1}, Landroid/support/v7/widget/TintTypedArray;->g(I)Landroid/content/res/ColorStateList;
    ...
    .line 129
    :cond_7
    invoke-virtual {v6}, Landroid/support/v7/widget/TintTypedArray;->e()V
