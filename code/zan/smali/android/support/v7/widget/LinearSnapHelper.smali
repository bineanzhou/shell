...
.method private a(Landroid/support/v7/widget/RecyclerView$LayoutManager;Landroid/support/v7/widget/OrientationHelper;II)I
    ...
    .line 167
    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/LinearSnapHelper;->b(Landroid/support/v7/widget/RecyclerView$LayoutManager;Landroid/support/v7/widget/OrientationHelper;)F
...
.method private b(Landroid/support/v7/widget/RecyclerView$LayoutManager;Landroid/support/v7/widget/OrientationHelper;)F
    .locals 10
    ...
    .line 246
    invoke-virtual {p1, v7}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->j(I)Landroid/view/View;

    move-result-object v4

    .line 247
    invoke-virtual {p1, v4}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->e(Landroid/view/View;)I
...
.method private c(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/support/v7/widget/OrientationHelper;
    ...
    .prologue
    .line 276
    iget-object v0, p0, Landroid/support/v7/widget/LinearSnapHelper;->d:Landroid/support/v7/widget/OrientationHelper;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/LinearSnapHelper;->d:Landroid/support/v7/widget/OrientationHelper;
...
.method private d(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/support/v7/widget/OrientationHelper;
    ...
    .prologue
    .line 285
    iget-object v0, p0, Landroid/support/v7/widget/LinearSnapHelper;->e:Landroid/support/v7/widget/OrientationHelper;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/LinearSnapHelper;->e:Landroid/support/v7/widget/OrientationHelper;
...
.method public a(Landroid/support/v7/widget/RecyclerView$LayoutManager;II)I
    ...
    .line 74
    :cond_2
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/LinearSnapHelper;->a(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/view/View;
    ...
    .line 79
    :cond_3
    invoke-virtual {p1, v0}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->e(Landroid/view/View;)I
    ...
    invoke-interface {v0, v2}, Landroid/support/v7/widget/RecyclerView$SmoothScroller$ScrollVectorProvider;->d(I)Landroid/graphics/PointF;
    ...
    .line 98
    invoke-direct {p0, p1}, Landroid/support/v7/widget/LinearSnapHelper;->d(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/support/v7/widget/OrientationHelper;
    ...
    .line 107
    invoke-direct {p0, p1}, Landroid/support/v7/widget/LinearSnapHelper;->c(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/support/v7/widget/OrientationHelper;
...
.method public a(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/view/View;
    ...
    invoke-direct {p0, p1, v0}, Landroid/support/v7/widget/LinearSnapHelper;->a(Landroid/support/v7/widget/RecyclerView$LayoutManager;Landroid/support/v7/widget/OrientationHelper;)Landroid/view/View;
...
.method public a(Landroid/support/v7/widget/RecyclerView$LayoutManager;Landroid/view/View;)[I
    ...
    .line 47
    invoke-direct {p0, p1, p2, v1}, Landroid/support/v7/widget/LinearSnapHelper;->a(Landroid/support/v7/widget/RecyclerView$LayoutManager;Landroid/view/View;Landroid/support/v7/widget/OrientationHelper;)I
