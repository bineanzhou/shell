...
.field final p:Landroid/support/v7/app/AppCompatCallback;
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Landroid/support/v7/app/AppCompatDelegateImplBase;->y:Z

    .line 55
    sget-boolean v0, Landroid/support/v7/app/AppCompatDelegateImplBase;->y:Z

    if-eqz v0, :cond_0

    sget-boolean v0, Landroid/support/v7/app/AppCompatDelegateImplBase;->x:Z
    ...
    .line 84
    sput-boolean v1, Landroid/support/v7/app/AppCompatDelegateImplBase;->x:Z
    ...
    sput-object v0, Landroid/support/v7/app/AppCompatDelegateImplBase;->z:[I
...
.method constructor <init>(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/app/AppCompatCallback;)V
    ...
    .line 116
    iput-object p1, p0, Landroid/support/v7/app/AppCompatDelegateImplBase;->l:Landroid/content/Context;

    .line 117
    iput-object p2, p0, Landroid/support/v7/app/AppCompatDelegateImplBase;->m:Landroid/view/Window;

    .line 118
    iput-object p3, p0, Landroid/support/v7/app/AppCompatDelegateImplBase;->p:Landroid/support/v7/app/AppCompatCallback;

    .line 120
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplBase;->m:Landroid/view/Window;

    invoke-virtual {v0}, Landroid/view/Window;->getCallback()Landroid/view/Window$Callback;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplBase;->n:Landroid/view/Window$Callback;

    .line 121
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplBase;->n:Landroid/view/Window$Callback;
    ...
    iput-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplBase;->o:Landroid/view/Window$Callback;

    .line 127
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplBase;->m:Landroid/view/Window;

    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplBase;->o:Landroid/view/Window$Callback;
    ...
    sget-object v1, Landroid/support/v7/app/AppCompatDelegateImplBase;->z:[I

    invoke-static {p1, v0, v1}, Landroid/support/v7/widget/TintTypedArray;->a(Landroid/content/Context;Landroid/util/AttributeSet;[I)Landroid/support/v7/widget/TintTypedArray;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/TintTypedArray;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 133
    iget-object v2, p0, Landroid/support/v7/app/AppCompatDelegateImplBase;->m:Landroid/view/Window;
...
.method public a()Landroid/support/v7/app/ActionBar;
    ...
    .prologue
    .line 148
    invoke-virtual {p0}, Landroid/support/v7/app/AppCompatDelegateImplBase;->n()V

    .line 149
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplBase;->q:Landroid/support/v7/app/ActionBar;
...
.method public final a(Ljava/lang/CharSequence;)V
    ...
    .prologue
    .line 291
    iput-object p1, p0, Landroid/support/v7/app/AppCompatDelegateImplBase;->A:Ljava/lang/CharSequence;
...
.method public b()Landroid/view/MenuInflater;
    ...
    .prologue
    .line 159
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplBase;->r:Landroid/view/MenuInflater;
    ...
    iput-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplBase;->r:Landroid/view/MenuInflater;
    ...
    .line 162
    :cond_1
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplBase;->l:Landroid/content/Context;
...
.method public c()V
    ...
    iput-boolean v0, p0, Landroid/support/v7/app/AppCompatDelegateImplBase;->B:Z
...
.method public g()V
    ...
    iput-boolean v0, p0, Landroid/support/v7/app/AppCompatDelegateImplBase;->C:Z

    .line 258
    return-void
.end method

.method public final h()Landroid/support/v7/app/ActionBarDrawerToggle$Delegate;
    .locals 1
...
.method final q()Z
    ...
    .prologue
    .line 278
    iget-boolean v0, p0, Landroid/support/v7/app/AppCompatDelegateImplBase;->C:Z
...
.method final r()Z
    ...
    .prologue
    .line 282
    iget-boolean v0, p0, Landroid/support/v7/app/AppCompatDelegateImplBase;->B:Z
...
.method final t()Ljava/lang/CharSequence;
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplBase;->A:Ljava/lang/CharSequence;
