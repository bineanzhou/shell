...
.method public constructor <init>(Landroid/support/v7/widget/AppCompatSpinner;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->q:Landroid/graphics/Rect;

    .line 707
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->b(Landroid/view/View;)V

    .line 708
    const/4 v0, 0x1

    invoke-virtual {p0, v0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->a(Z)V

    .line 709
    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->a(I)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->a(Landroid/widget/AdapterView$OnItemClickListener;)V
...
.method public a()V
    ...
    .prologue
    .line 777
    invoke-virtual {p0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->e()Z

    move-result v0

    .line 779
    invoke-virtual {p0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->c()V

    .line 781
    const/4 v1, 0x2

    invoke-virtual {p0, v1}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->k(I)V

    .line 782
    invoke-super {p0}, Landroid/support/v7/widget/ListPopupWindow;->a()V

    .line 783
    invoke-virtual {p0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->g()Landroid/widget/ListView;
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->l(I)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->a(Landroid/widget/PopupWindow$OnDismissListener;)V
...
.method public a(Ljava/lang/CharSequence;)V
    ...
    .prologue
    .line 736
    iput-object p1, p0, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->p:Ljava/lang/CharSequence;
...
.method a(Landroid/view/View;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->q:Landroid/graphics/Rect;
...
.method public b()Ljava/lang/CharSequence;
    ...
    .prologue
    .line 731
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->p:Ljava/lang/CharSequence;
...
.method c()V
    ...
    .line 740
    invoke-virtual {p0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->k()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->h(I)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->p()I
    ...
    .line 773
    :goto_4
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->d(I)V
