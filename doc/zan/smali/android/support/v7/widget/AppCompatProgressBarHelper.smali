...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/AppCompatProgressBarHelper;->a:[I
...
.method constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    .line 47
    iput-object p1, p0, Landroid/support/v7/widget/AppCompatProgressBarHelper;->b:Landroid/widget/ProgressBar;
...
.method private a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 99
    iget-object v1, p0, Landroid/support/v7/widget/AppCompatProgressBarHelper;->c:Landroid/graphics/Bitmap;

    if-nez v1, :cond_7

    .line 100
    iput-object v0, p0, Landroid/support/v7/widget/AppCompatProgressBarHelper;->c:Landroid/graphics/Bitmap;
...
.method a()Landroid/graphics/Bitmap;
    ...
    .prologue
    .line 144
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatProgressBarHelper;->c:Landroid/graphics/Bitmap;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 51
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatProgressBarHelper;->b:Landroid/widget/ProgressBar;

    invoke-virtual {v0}, Landroid/widget/ProgressBar;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Landroid/support/v7/widget/AppCompatProgressBarHelper;->a:[I

    invoke-static {v0, p1, v1, p2, v3}, Landroid/support/v7/widget/TintTypedArray;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/TintTypedArray;

    move-result-object v0

    .line 54
    invoke-virtual {v0, v3}, Landroid/support/v7/widget/TintTypedArray;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 56
    iget-object v2, p0, Landroid/support/v7/widget/AppCompatProgressBarHelper;->b:Landroid/widget/ProgressBar;
