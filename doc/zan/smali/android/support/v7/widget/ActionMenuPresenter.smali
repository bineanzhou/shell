...
.field private B:Landroid/support/v7/widget/ActionMenuPresenter$ActionMenuPopupCallback;
...
.method public a(Landroid/support/v7/view/menu/MenuItemImpl;Landroid/support/v7/view/menu/MenuView$ItemView;)V
    ...
    .line 217
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->B:Landroid/support/v7/widget/ActionMenuPresenter$ActionMenuPopupCallback;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter;->B:Landroid/support/v7/widget/ActionMenuPresenter$ActionMenuPopupCallback;
...
.method public a(Landroid/support/v7/view/menu/SubMenuBuilder;)Z
    ...
    .line 291
    :goto_1
    invoke-virtual {v0}, Landroid/support/v7/view/menu/SubMenuBuilder;->t()Landroid/view/Menu;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/ActionMenuPresenter;->i:Landroid/support/v7/widget/ActionMenuPresenter$ActionButtonSubmenu;

    .line 316
    iget-object v2, p0, Landroid/support/v7/widget/ActionMenuPresenter;->i:Landroid/support/v7/widget/ActionMenuPresenter$ActionButtonSubmenu;

    invoke-virtual {v2, v0}, Landroid/support/v7/widget/ActionMenuPresenter$ActionButtonSubmenu;->a(Z)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ActionMenuPresenter$ActionButtonSubmenu;->c()V
...
.method public b()Z
    ...
    invoke-virtual {v2}, Landroid/support/v7/view/menu/MenuBuilder;->j()Ljava/util/ArrayList;
    ...
    .line 442
    invoke-virtual {v3}, Landroid/support/v7/view/menu/MenuItemImpl;->l()Z
    ...
    .line 444
    :cond_1
    invoke-virtual {v3}, Landroid/support/v7/view/menu/MenuItemImpl;->k()Z
    ...
    invoke-virtual {v0, v3, v8, v2}, Landroid/support/v7/widget/ActionMenuPresenter;->a(Landroid/support/v7/view/menu/MenuItemImpl;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {v3, v9}, Landroid/support/v7/view/menu/MenuItemImpl;->d(Z)V
    ...
    invoke-virtual {v0, v3, v10, v2}, Landroid/support/v7/widget/ActionMenuPresenter;->a(Landroid/support/v7/view/menu/MenuItemImpl;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 553
    :cond_e
    invoke-virtual {v3, v13}, Landroid/support/v7/view/menu/MenuItemImpl;->d(Z)V
    ...
    invoke-virtual {v4, v0}, Landroid/support/v7/view/menu/MenuItemImpl;->d(Z)V
    ...
    invoke-virtual {v3, v8}, Landroid/support/v7/view/menu/MenuItemImpl;->d(Z)V
