...
.method constructor <init>(Landroid/support/v7/widget/ActivityChooserModel;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserModel$DefaultSorter;->c:Ljava/util/Map;
...
.method public a(Landroid/content/Intent;Ljava/util/List;Ljava/util/List;)V
    ...
    .prologue
    .line 926
    iget-object v4, p0, Landroid/support/v7/widget/ActivityChooserModel$DefaultSorter;->c:Ljava/util/Map;
    ...
    iput v3, v0, Landroid/support/v7/widget/ActivityChooserModel$ActivityResolveInfo;->b:F

    .line 934
    new-instance v3, Landroid/content/ComponentName;

    iget-object v5, v0, Landroid/support/v7/widget/ActivityChooserModel$ActivityResolveInfo;->a:Landroid/content/pm/ResolveInfo;

    iget-object v5, v5, Landroid/content/pm/ResolveInfo;->activityInfo:Landroid/content/pm/ActivityInfo;

    iget-object v5, v5, Landroid/content/pm/ActivityInfo;->packageName:Ljava/lang/String;

    iget-object v6, v0, Landroid/support/v7/widget/ActivityChooserModel$ActivityResolveInfo;->a:Landroid/content/pm/ResolveInfo;
    ...
    .line 944
    iget-object v1, v0, Landroid/support/v7/widget/ActivityChooserModel$HistoricalRecord;->a:Landroid/content/ComponentName;
    ...
    .line 947
    iget v5, v1, Landroid/support/v7/widget/ActivityChooserModel$ActivityResolveInfo;->b:F

    iget v0, v0, Landroid/support/v7/widget/ActivityChooserModel$HistoricalRecord;->c:F

    mul-float/2addr v0, v2

    add-float/2addr v0, v5

    iput v0, v1, Landroid/support/v7/widget/ActivityChooserModel$ActivityResolveInfo;->b:F
