...
.method public constructor <init>(Landroid/support/v7/widget/ScrollingTabContainerView;Landroid/content/Context;Landroid/support/v7/app/ActionBar$Tab;Z)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->b:[I

    .line 392
    iput-object p3, p0, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->c:Landroid/support/v7/app/ActionBar$Tab;

    .line 394
    iget-object v0, p0, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->b:[I

    sget v1, Landroid/support/v7/appcompat/R$attr;->actionBarTabStyle:I

    invoke-static {p2, v3, v0, v1, v2}, Landroid/support/v7/widget/TintTypedArray;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/TintTypedArray;

    move-result-object v0

    .line 396
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/TintTypedArray;->j(I)Z
...
.method public onLongClick(Landroid/view/View;)Z
    ...
    invoke-virtual {v5}, Landroid/support/v7/app/ActionBar$Tab;->g()Ljava/lang/CharSequence;
...
.method public onMeasure(II)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->a:Landroid/support/v7/widget/ScrollingTabContainerView;
...
.method public update()V
    ...
    .line 451
    iget-object v2, p0, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->c:Landroid/support/v7/app/ActionBar$Tab;

    .line 452
    invoke-virtual {v2}, Landroid/support/v7/app/ActionBar$Tab;->d()Landroid/view/View;
    ...
    .line 459
    :cond_1
    iput-object v3, p0, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->l:Landroid/view/View;
    ...
    .line 461
    :cond_2
    iget-object v0, p0, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->k:Landroid/widget/ImageView;
    ...
    .line 466
    :cond_4
    iget-object v0, p0, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->l:Landroid/view/View;
    ...
    .line 468
    iput-object v7, p0, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->l:Landroid/view/View;

    .line 471
    :cond_5
    invoke-virtual {v2}, Landroid/support/v7/app/ActionBar$Tab;->b()Landroid/graphics/drawable/Drawable;

    move-result-object v0

    .line 472
    invoke-virtual {v2}, Landroid/support/v7/app/ActionBar$Tab;->c()Ljava/lang/CharSequence;
    ...
    .line 475
    iget-object v4, p0, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->k:Landroid/widget/ImageView;
    ...
    .line 482
    iput-object v4, p0, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->k:Landroid/widget/ImageView;
    ...
    .line 502
    iput-object v4, p0, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->d:Landroid/widget/TextView;
    ...
    .line 505
    iget-object v3, p0, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->d:Landroid/widget/TextView;
    ...
    :cond_9
    :goto_3
    iget-object v3, p0, Landroid/support/v7/widget/ScrollingTabContainerView$TabView;->k:Landroid/widget/ImageView;
    ...
    invoke-virtual {v2}, Landroid/support/v7/app/ActionBar$Tab;->g()Ljava/lang/CharSequence;
