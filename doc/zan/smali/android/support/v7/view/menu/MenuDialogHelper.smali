...
.method public a(Landroid/os/IBinder;)V
    ...
    .line 65
    invoke-virtual {v0}, Landroid/support/v7/view/menu/MenuBuilder;->p()Landroid/view/View;
    ...
    .line 71
    :cond_1
    invoke-virtual {v0}, Landroid/support/v7/view/menu/MenuBuilder;->o()Landroid/graphics/drawable/Drawable;
...
.method public a(Landroid/support/v7/view/menu/MenuPresenter$Callback;)V
    ...
    .prologue
    .line 128
    iput-object p1, p0, Landroid/support/v7/view/menu/MenuDialogHelper;->d:Landroid/support/v7/view/menu/MenuPresenter$Callback;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    .prologue
    .line 166
    iget-object v1, p0, Landroid/support/v7/view/menu/MenuDialogHelper;->b:Landroid/support/v7/view/menu/MenuBuilder;

    iget-object v0, p0, Landroid/support/v7/view/menu/MenuDialogHelper;->a:Landroid/support/v7/view/menu/ListMenuPresenter;

    invoke-virtual {v0}, Landroid/support/v7/view/menu/ListMenuPresenter;->a()Landroid/widget/ListAdapter;
    ...
    invoke-virtual {v1, v0, v2}, Landroid/support/v7/view/menu/MenuBuilder;->a(Landroid/view/MenuItem;I)Z
...
.method public onDismiss(Landroid/content/DialogInterface;)V
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v7/view/menu/ListMenuPresenter;->a(Landroid/support/v7/view/menu/MenuBuilder;Z)V
...
.method public onKey(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
    ...
    .line 95
    iget-object v1, p0, Landroid/support/v7/view/menu/MenuDialogHelper;->c:Landroid/support/v7/app/AlertDialog;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/view/menu/MenuBuilder;->b(Z)V
