...
.method public constructor <init>(Landroid/support/v7/view/SupportMenuInflater;Landroid/view/Menu;)V
    ...
    .prologue
    .line 333
    iput-object p1, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->b:Landroid/support/v7/view/SupportMenuInflater;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    .line 334
    iput-object p2, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->c:Landroid/view/Menu;
...
.method private a(Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 501
    :try_start_0
    iget-object v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->b:Landroid/support/v7/view/SupportMenuInflater;
...
.method private a(Landroid/view/MenuItem;)V
    ...
    .line 429
    iget-boolean v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->s:Z
    ...
    iget-boolean v3, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->u:Z
    ...
    iget v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->r:I
    ...
    iget-object v3, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->n:Ljava/lang/CharSequence;
    ...
    iget v3, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->o:I
    ...
    iget-char v3, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->q:C
    ...
    .line 442
    :cond_0
    iget-object v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->z:Ljava/lang/String;
    ...
    iget-object v3, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->b:Landroid/support/v7/view/SupportMenuInflater;
    ...
    iget-object v4, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->z:Ljava/lang/String;
    ...
    .line 467
    :goto_2
    iget v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->w:I
    ...
    :cond_6
    :goto_3
    iget-object v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->a:Landroid/support/v4/view/ActionProvider;
...
.method public a()V
    ...
    .line 343
    iput v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->g:I

    .line 344
    iput-boolean v1, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->h:Z

    .line 345
    iput-boolean v1, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->i:Z
...
.method public a(Landroid/util/AttributeSet;)V
    ...
    iput v1, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->g:I
...
.method public b()V
    ...
    iput-boolean v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->j:Z

    .line 483
    iget-object v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->c:Landroid/view/Menu;

    iget v1, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->d:I

    iget v2, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->k:I

    iget v3, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->l:I

    iget-object v4, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->m:Ljava/lang/CharSequence;
...
.method public b(Landroid/util/AttributeSet;)V
    ...
    iget v4, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->e:I
    ...
    iget v5, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->f:I
    ...
    iput v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->l:I
    ...
    iput-object v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->n:Ljava/lang/CharSequence;
    ...
    iput v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->o:I
    ...
    iput-char v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->q:C
    ...
    :goto_0
    iput v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->r:I
    ...
    iget-boolean v4, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->i:Z

    invoke-virtual {v3, v0, v4}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v0

    iput-boolean v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->u:Z
    ...
    iput-object v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->z:Ljava/lang/String;
    ...
    iput v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->w:I
    ...
    iget-object v4, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->b:Landroid/support/v7/view/SupportMenuInflater;
    ...
    iput-object v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->a:Landroid/support/v4/view/ActionProvider;
    ...
    .line 417
    iput-boolean v2, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->j:Z
    ...
    .line 391
    :cond_1
    iget v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->g:I
...
.method public d()Z
    ...
    .prologue
    .line 494
    iget-boolean v0, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->j:Z
