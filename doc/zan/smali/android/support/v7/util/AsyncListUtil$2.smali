...
.method private a()Landroid/support/v7/util/TileList$Tile;
    ...
    iget-object v1, v1, Landroid/support/v7/util/TileList$Tile;->d:Landroid/support/v7/util/TileList$Tile;
    ...
    iget-object v1, v1, Landroid/support/v7/util/AsyncListUtil;->c:Ljava/lang/Class;

    iget-object v2, p0, Landroid/support/v7/util/AsyncListUtil$2;->b:Landroid/support/v7/util/AsyncListUtil;

    iget v2, v2, Landroid/support/v7/util/AsyncListUtil;->d:I
...
.method private a(IIIZ)V
    ...
    iget-object v2, v2, Landroid/support/v7/util/AsyncListUtil;->i:Landroid/support/v7/util/ThreadUtil$BackgroundCallback;

    invoke-interface {v2, v0, p3}, Landroid/support/v7/util/ThreadUtil$BackgroundCallback;->a(II)V

    .line 351
    iget-object v0, p0, Landroid/support/v7/util/AsyncListUtil$2;->b:Landroid/support/v7/util/AsyncListUtil;

    iget v0, v0, Landroid/support/v7/util/AsyncListUtil;->d:I
...
.method private b(Landroid/support/v7/util/TileList$Tile;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget v1, p1, Landroid/support/v7/util/TileList$Tile;->b:I
    ...
    iget-object v0, v0, Landroid/support/v7/util/AsyncListUtil;->h:Landroid/support/v7/util/ThreadUtil$MainThreadCallback;

    iget v1, p0, Landroid/support/v7/util/AsyncListUtil$2;->d:I

    invoke-interface {v0, v1, p1}, Landroid/support/v7/util/ThreadUtil$MainThreadCallback;->a(ILandroid/support/v7/util/TileList$Tile;)V
...
.method private d(I)V
    ...
    invoke-interface {v0, v1, p1}, Landroid/support/v7/util/ThreadUtil$MainThreadCallback;->b(II)V
...
.method private e(I)V
    ...
    iget-object v0, v0, Landroid/support/v7/util/AsyncListUtil;->e:Landroid/support/v7/util/AsyncListUtil$DataCallback;

    invoke-virtual {v0}, Landroid/support/v7/util/AsyncListUtil$DataCallback;->b()I
    ...
    .line 425
    :cond_0
    invoke-direct {p0, v1}, Landroid/support/v7/util/AsyncListUtil$2;->d(I)V
    ...
    .line 428
    :cond_2
    invoke-direct {p0, v2}, Landroid/support/v7/util/AsyncListUtil$2;->d(I)V
...
.method public a(I)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/util/AsyncListUtil$DataCallback;->a()I
    ...
    invoke-interface {v0, v1, v2}, Landroid/support/v7/util/ThreadUtil$MainThreadCallback;->a(II)V
...
.method public a(II)V
    ...
    .prologue
    .line 362
    invoke-direct {p0, p1}, Landroid/support/v7/util/AsyncListUtil$2;->c(I)Z
    ...
    .line 369
    iput p1, v0, Landroid/support/v7/util/TileList$Tile;->b:I

    .line 370
    iget-object v1, p0, Landroid/support/v7/util/AsyncListUtil$2;->b:Landroid/support/v7/util/AsyncListUtil;

    iget v1, v1, Landroid/support/v7/util/AsyncListUtil;->d:I
    ...
    iput v1, v0, Landroid/support/v7/util/TileList$Tile;->c:I

    .line 371
    iget-object v1, p0, Landroid/support/v7/util/AsyncListUtil$2;->b:Landroid/support/v7/util/AsyncListUtil;

    iget-object v1, v1, Landroid/support/v7/util/AsyncListUtil;->e:Landroid/support/v7/util/AsyncListUtil$DataCallback;

    iget-object v2, v0, Landroid/support/v7/util/TileList$Tile;->a:[Ljava/lang/Object;

    iget v3, v0, Landroid/support/v7/util/TileList$Tile;->b:I

    iget v4, v0, Landroid/support/v7/util/TileList$Tile;->c:I

    invoke-virtual {v1, v2, v3, v4}, Landroid/support/v7/util/AsyncListUtil$DataCallback;->a([Ljava/lang/Object;II)V

    .line 372
    invoke-direct {p0, p2}, Landroid/support/v7/util/AsyncListUtil$2;->e(I)V

    .line 373
    invoke-direct {p0, v0}, Landroid/support/v7/util/AsyncListUtil$2;->b(Landroid/support/v7/util/TileList$Tile;)V
...
.method public a(IIIII)V
    ...
    .line 322
    :cond_0
    invoke-direct {p0, p1}, Landroid/support/v7/util/AsyncListUtil$2;->b(I)I

    move-result v0

    .line 323
    invoke-direct {p0, p2}, Landroid/support/v7/util/AsyncListUtil$2;->b(I)I

    move-result v1

    .line 325
    invoke-direct {p0, p3}, Landroid/support/v7/util/AsyncListUtil$2;->b(I)I
    ...
    .line 326
    invoke-direct {p0, p4}, Landroid/support/v7/util/AsyncListUtil$2;->b(I)I
...
.method public a(Landroid/support/v7/util/TileList$Tile;)V
    ...
    iget-object v1, p1, Landroid/support/v7/util/TileList$Tile;->a:[Ljava/lang/Object;

    iget v2, p1, Landroid/support/v7/util/TileList$Tile;->c:I

    invoke-virtual {v0, v1, v2}, Landroid/support/v7/util/AsyncListUtil$DataCallback;->a([Ljava/lang/Object;I)V

    .line 383
    iget-object v0, p0, Landroid/support/v7/util/AsyncListUtil$2;->c:Landroid/support/v7/util/TileList$Tile;

    iput-object v0, p1, Landroid/support/v7/util/TileList$Tile;->d:Landroid/support/v7/util/TileList$Tile;
